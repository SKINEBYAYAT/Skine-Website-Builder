...
import { Menu, X, Moon, Sun, Instagram, ArrowUp } from 'lucide-react';
  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          'fixed bottom-6 z-50 p-3 rounded-full bg-primary text-primary-foreground shadow-lg',
          'transition-all duration-300 hover:scale-110 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary',
